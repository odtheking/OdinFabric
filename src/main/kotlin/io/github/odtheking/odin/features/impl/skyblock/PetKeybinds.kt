...
import io.github.odtheking.odin.clickgui.settings.impl.ListSetting
...
import io.github.odtheking.odin.utils.loreString
    ...
    private fun onClick(screen: HandledScreen<*>, keyCode: Int): Boolean {
        ...
        val index = when (keyCode) {
            ...
            unequipKeybind.code ->
                ...
                val petIndex =
                    arrayOf(pet1, pet2, pet3, pet4, pet5, pet6, pet7, pet8, pet9).indexOfFirst { it.code == keyCode }
