...
object PlayerDisplay : Module(
    ...
    private val healthHud by HUD("Health HUD", "Displays the player's health.") { example ->
        ...
        return@HUD drawStringWidth(generateText(text.first, text.second, "❤"), 1, 1, healthColor) + 2 to mc.font.lineHeight
    }
    ...
    private val manaHud by HUD("Mana HUD", "Displays the player's mana.") { example ->
        ...
        return@HUD drawStringWidth(text, 1, 1, manaColor) + 2 to mc.font.lineHeight
    }
    ...
    private val overflowManaHud by HUD("Overflow Mana HUD", "Displays the player's overflow mana.") { example ->
        ...
        return@HUD drawStringWidth(generateText(text, "ʬ", hideZeroSF), 1, 1, overflowManaColor) + 2 to mc.font.lineHeight
    }
    ...
    private val defenseHud by HUD("Defense HUD", "Displays the player's defense.") { example ->
        ...
        return@HUD drawStringWidth(generateText(text, "❈", true), 1, 1, defenseColor) + 2 to mc.font.lineHeight
    }
    ...
    private val eHPHud by HUD("EHP HUD", "Displays the player's effective health (EHP).") { example ->
        ...
        return@HUD drawStringWidth(generateText(text, "", true), 1, 1, ehpColor) + 2 to mc.font.lineHeight
    }
