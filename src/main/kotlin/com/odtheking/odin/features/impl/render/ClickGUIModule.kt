...
object ClickGUIModule : Module(
    ...
    val hypixelApiUrl by StringSetting("Api Server", "https://api.odtheking.com/hypixel/", 128, "The Hypixel API server to connect to.").hide()
    val webSocketUrl by StringSetting("WebSocket Server", "https://api.odtheking.com/ws/", 128, "The Websocket server to connect to.").hide()
