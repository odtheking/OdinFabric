...
object NumbersSim : TermSimGUI(
    ...
    override fun create() {
        ...
        createNewGui {
            if (floor(it.index / 9f) in 1f..2f && it.index % 9 in 1..7) ItemStack(Items.RED_STAINED_GLASS_PANE, used.removeFirst()).apply { set(DataComponents.CUSTOM_NAME, Component.literal("")) }
            else blackPane
        }
    }
